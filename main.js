window.addEventListener('load', function() {
    ...
    class Projectile {
        constructor(game, x, y) {
            ...
            this.width = 36.25;
            this.height = 20;
            this.speed = Math.random() * 0.2 + 2.9;
            this.frameX = 0;
            this.maxFrame = 3;
            this.fps = 20;
    ...
    class Particle {
        ...
        constructor(game, x, y) {
            ...
            // random number between -3 and +3 (negative: left ; positive: right)
            this.speedX = Math.random() * 6 - 3;
            // particles start to move upwards
    ...
    class SoundController {
        constructor() {
            ...
            this.powerExplosionSound = document.getElementById('explosion');
        ...
        explosion() {
            this.powerExplosionSound.currentTime = 0;
            this.powerExplosionSound.play();
        }
        shot() {
    ...
    class UI {
        ...
        draw(context) {
            ...
            for(let i = 0 ; i < this.game.ammo ; i++) {
                context.fillRect(20 + 5 * i, 50, 3, 30);
            }
            context.restore();
        }
    }
    class Game {
        constructor(width, height) {
            ...
            // shield must be AFTER the player instance
            ...
            this.enemies.forEach(enemy => {
                ...
                this.player.projectiles.forEach(projectile => {
                    if(this.checkCollision(enemy, projectile)) {
                        ...
                        this.particles.push(new Particle(this, enemy.x + enemy.width * 0.5, enemy.y + 
                            enemy.height * 0.5));
                        if(enemy.lives <= 0) {
                            for(let i = 0 ; i < enemy.score ; i++) {
                                this.particles.push(new Particle(this, enemy.x + 
        ...
        draw(context) {
            // what is drawn first is what's drawn BEHIND!
